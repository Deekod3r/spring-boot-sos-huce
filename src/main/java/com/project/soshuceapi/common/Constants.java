        ...
        public final static String VERIFY_BODY = """
            <html>
                <div class="container" style="max-width: 600px; margin: 50px auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    ...
                    <p style="color: #666;">Cảm ơn vì đã tham gia cộng đồng SOS HUCE. Dưới đây là mã xác thực <b style="color: #3B82F6;">%s</b>:</p>
                    <div class="verification-code" style="background-color: #3B82F6; color: #fff; padding: 10px; font-size: 18px; border-radius: 4px; margin: 20px 0; display: inline-block;">%s</div>
